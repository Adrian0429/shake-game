...
const CreateReferralTaskPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await axios.post(
        "https://api2.fingo.co.id/api/user/tasks/referral/create",
        taskData,
        {
          headers: {
      ...
      console.error("Error creating Referral task:", error);
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen p-5">
      <h1 className="text-2xl font-bold mb-5">Create Referral Task</h1>
...
export default CreateReferralTaskPage;
